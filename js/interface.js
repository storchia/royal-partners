;(function ($) {
  ...
  navbar.on('affix.bs.affix', function () {
    if (!navbar.hasClass('affix')) {
      ...
      document
        .querySelector('#top a img')
        .setAttribute('src', 'img/logo-nav-black.png')
      document
        .querySelector('#top a picture source')
        .setAttribute('srcset', 'img/logo-nav-black.png')
      document
        .querySelectorAll('.navbar-toggle.collapsed .icon-bar')
        .forEach(el => {
  ...
  navbar.on('affix-top.bs.affix', function () {
    ...
    document.querySelector('#top a img').setAttribute('src', 'img/logo-nav.png')
    document
      .querySelector('#top a picture source')
      .setAttribute('srcset', 'img/logo-nav.png')
    document
      .querySelectorAll('.navbar-toggle.collapsed .icon-bar')
      .forEach(el => {
  ...
  try {
    let succ = urlParams.get('success')
    if (succ == 1) {
      $('.modal').modal('hide')
      $('#success').modal('show')
    } else if (succ == -1) {
